 ...
 */
package cn.fishy.plugin.idea.webxlink.util;
...
public class PsiClassManager implements ProjectComponent {
    ...
    public static PsiClassManager getInstance(Project project){
        return project.getComponent(PsiClassManager.class);
    }
...
//        }
    ...
    private static final Logger LOG = Logger.getInstance("cn.fishy.plugin.idea.webxlink.util.PsiClassManager");
    ...
    public String getComponentName() {
        return "cn.fishy.plugin.idea.webxlink.util.PsiClassManager";
    }
}
